...
public class InterClass
{
    ...
    // The Ajax form also sends O for the Other option, so validation must accept it.
    [RegularExpression("M|F", ErrorMessage = "Gender must be 'M', 'F' ")]
    [Display(Name = "Gender")]
    ...
    public DateOnly? DateOfPresentation { get; set; }
    // Corresponds to c_Date_Of_Presentation (Date)
