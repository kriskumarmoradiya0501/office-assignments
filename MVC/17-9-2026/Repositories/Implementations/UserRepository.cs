        ...
        try
        {
            using (NpgsqlCommand cmd = new NpgsqlCommand(qry, _conn))
            {
                ...
                if (reader.Read())
                {
                    ...
                    UserData.c_Gender = reader["c_gender"] != DBNull.Value ? (string)reader["c_gender"] : null;
                    UserData.c_Mobile = reader["c_mobile"] != DBNull.Value ? (string)reader["c_mobile"] : null;
                    UserData.c_Address = reader["c_address"] != DBNull.Value ? (string)reader["c_address"] : null;
                    UserData.c_Image = reader["c_image"] != DBNull.Value ? (string)reader["c_image"] : null;            
                }
            }
        }
        catch (Exception e)
